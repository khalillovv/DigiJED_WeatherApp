package com.example.a01.fragments.home

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import coil.load
import com.example.a01.data.CurrentLocation
import com.example.a01.data.CurrentWeather
import com.example.a01.data.Forecast
import com.example.a01.data.WeatherData
import com.example.a01.databinding.ItemContainerCurrentLocationBinding
import com.example.a01.databinding.ItemContainerCurrentWeatherBinding
import com.example.a01.databinding.ItemContainerForecastBinding
    ...
    inner class CurrentWeatherViewHolder(
        ...
        fun bind(currentWeather: CurrentWeather) {
            with(binding) {
                ...
                textWind.text = String.format("%s kh/h", currentWeather.wind)
